...
export const DEFAULT_SYSTEM_SETTINGS: SystemSettings = {
  ...
  socialMedia: {
    platforms: [
      ...
      { id: "soc_6", platform: "LinkedIn", url: "https://linkedin.com/company/arzamart", iconName: "Linkedin", displayOrder: 6, active: false },
      { id: "soc_7", platform: "X (Twitter)", url: "https://x.com/arzamart_bd", iconName: "Twitter", displayOrder: 7, active: false },
      { id: "soc_8", platform: "Telegram", url: "https://t.me/arzamart_official", iconName: "Send", displayOrder: 8, active: false },
      { id: "soc_9", platform: "Pinterest", url: "https://pinterest.com/arzamart", iconName: "Pin", displayOrder: 9, active: false },
    ],
    sources: {
      "Facebook Page": [
        "Arzamart Official FB Page",
        "Arzamart Fashion FB Page",
        "Arzamart Luxury FB Page",
        "Arzamart VIP FB Group",
        "Arzamart Clearance FB",
      ],
      "Instagram DM": [
        "Arzamart Main IG (@arzamart.official)",
        "Arzamart Fashion IG (@arzamart.fashion)",
        "Arzamart Studio IG (@arzamart.studio)",
        "Arzamart Outfits IG (@arzamart.outfits)",
      ],
      "WhatsApp": [
      ...
      "TikTok": [
        "Arzamart Official TikTok (@arzamart.bd)",
        "Arzamart TikTok Shop",
        "Arzamart Live TikTok Channel",
      ],
      "Website": [
        "Arzamart Main Website (arzamart.com)",
        "Arzamart Checkout Landing Page",
        "Arzamart Seasonal Promo Page",
      ],
      "Phone Call": [
  ...
  seo: {
    ...
    metaKeywords: "fashion, dresses, arzamart, clothing, online shopping bangladesh, shirts, panjabi, tees",
