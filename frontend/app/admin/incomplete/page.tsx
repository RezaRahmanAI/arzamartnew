...
export default function AdminIncomplete() {
  ...
  const filteredIncomplete = useMemo(() => {
    ...
    return filtered;
  }, [data, orderIdQuery, phoneQuery, statusFilter, dateRange]);
      ...
      <div className="space-y-2.5">
        <div className="flex flex-wrap items-center gap-3 bg-card p-3 rounded-xl border shadow-sm">
          ...
          <Popover>
            ...
            <PopoverContent className="w-72 p-4 space-y-3 shadow-lg" align="start">
              <div className="flex items-center justify-between pb-2 border-b border-border">
                <h4 className="text-xs font-bold uppercase tracking-wider text-foreground">Filter Status</h4>
                {statusFilter !== "all" && (
                  <Button
                    type="button"
                    variant="ghost"
                ...
                <TableRow key={o.id} className="group">
                  ...
                  <TableCell>
                    <Link
                      ...
                      className="font-medium hover:underline hover:text-primary transition-colors block max-w-[140px] truncate group-hover:flex group-hover:items-center group-hover:gap-1"
                  ...
                  <TableCell className="text-right">
                    <div className="flex flex-wrap justify-end gap-1.5 min-w-[200px]">
                      ...
                      >
                        ...
                        {(o.hasNotes ||
                          Boolean(o.note) ||
                          (getSavedNotesStore()[o.id]?.length ?? 0) > 0) && (
